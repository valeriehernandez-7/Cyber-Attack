...
/**
 * Set the scene on main screen view.
 */
public class MainScreen extends SceneController implements KeyListener {

    private BufferedImage backgroundImg;

    public MainScreen(SceneSetup sceneSetup) {
        super(sceneSetup);

        try {
            URL bgPath = this.getClass().getResource("/elements/s.main.png");
